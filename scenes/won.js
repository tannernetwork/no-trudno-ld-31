...
WonScene.prototype = {
	update: function ()
	{
		setTimeout(function(){this.ready = true}.bind(this), 3000);
	},
	...
	render: function (time)
	{
		...
		this.context.shadowBlur = 2;
			...
			this.context.fillText('YEAH, THIS GAME IS A JOKE.', this.game.root.width - 120, 60);
			this.context.fillText('ENTIRE WIN ON THE SCREEN! PRESS ANY KEY.', this.game.root.width - 120, this.game.root.height - 60);
